...
<!-- Mirrored from new.axilthemes.com/demo/template/keystroke/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Aug 2023 02:07:38 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-7 order-1 order-lg-2">
                            <div class="breadcrumb-thumbnail-group with-image-group text-start text-lg-end">
                                <div class="thumbnail">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="axil-service text-start axil-control paralax-image active">
                                    <div class="inner">
                                        <div class="icon">
                            ...
                            <!-- Start Single Service  -->
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="axil-service text-start axil-control paralax-image">
                                    <div class="inner">
                        ...
                        <div class="row row--0 ptb--20 axil-basic-thine-line">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="inner text-center text-md-start">
                                    <p>© 2021. All rights reserved by Your Company.</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
...
<!-- Mirrored from new.axilthemes.com/demo/template/keystroke/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Aug 2023 02:07:39 GMT -->
</html>